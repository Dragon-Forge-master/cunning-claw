...
| **penblwydd** | birthday | an annual swyn (`08:30:01/03`) — the spellbook learned about years for this |
...
Annual dates also parse — `01/03` (fires 09:00) or `08:30:01/03` — so a
penblwydd is a spell like any other, cast once a year:

```
- [x] schedule: `08:30:01/03` | target: `penblwydd` | instruction: Penblwydd hapus, Archdderwydd.
```
