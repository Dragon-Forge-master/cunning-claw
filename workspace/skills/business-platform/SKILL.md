...
The operator has already shipped one of these. **Read the operator's own estimating platform (a private repo — ask which) before you
...
core feature, Resend for email, and the operator's garage as tenant #1.
...
**No build step is a deliberate choice, not laziness.** The reference platform serves plain HTML and JS
